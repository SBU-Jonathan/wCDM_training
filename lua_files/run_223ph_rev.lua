...
ic_input_filename = "/scratch/decola/joao.reboucas2/COLA_projects/wCDM/transferinfo_files/transferinfo223.txt"

output_folder = "/scratch/decola/joao.reboucas2/COLA_projects/wCDM/outputs/223ph_rev"
simulation_name = "run_223ph_rev"
