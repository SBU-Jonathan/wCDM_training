...
ic_input_filename = "/scratch/decola/joao.reboucas2/COLA_projects/wCDM/transferinfo_files/transferinfo178.txt"

output_folder = "/scratch/decola/joao.reboucas2/COLA_projects/wCDM/outputs/178ph_rev"
simulation_name = "run_178ph_rev"
...
cosmology_OmegaCDM = 0.2968143343339302
cosmology_Omegab = 0.05350358055305444
cosmology_OmegaMNu = 0.0015550628496624876
...
cosmology_h = 0.6329514487779916
cosmology_As = 2.14215909475688e-09
cosmology_ns = 0.9814462932292312
cosmology_kpivot_mpc = 0.05
if cosmology_model == "w0waCDM" then 
  cosmology_w0 = -0.6747629815140137
  cosmology_wa = 0.0
end
