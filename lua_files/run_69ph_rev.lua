...
ic_input_filename = "/scratch/decola/joao.reboucas2/COLA_projects/wCDM/transferinfo_files/transferinfo69.txt"

output_folder = "/scratch/decola/joao.reboucas2/COLA_projects/wCDM/outputs/69ph_rev"
simulation_name = "run_69ph_rev"
...
cosmology_OmegaCDM = 0.3542647434583052
cosmology_Omegab = 0.04202383794267087
cosmology_OmegaMNu = 0.001467249191704446
...
cosmology_h = 0.6516170812026428
cosmology_As = 1.7635447090634347e-09
cosmology_ns = 0.9429909692020702
cosmology_kpivot_mpc = 0.05
if cosmology_model == "w0waCDM" then 
  cosmology_w0 = -1.07551486999012
  cosmology_wa = 0.0
end
